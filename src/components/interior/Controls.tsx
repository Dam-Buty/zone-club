...
export function Controls({ onCassetteClick, isMobile, mobileInputRef }: ControlsProps) {
  ...
  }, [isMobile, pointerLockRequested, clearPointerLockRequest, managerVisible, selectedFilmId, isTerminalOpen, isVHSCaseOpen])
  ...
  }, [isMobile, onCassetteClick, showManager, openTerminal, requestPointerUnlock])
  ...
  useFrame((_, delta) => {
    ...
    if (isActive && shouldRaycast) {
      ...
      for (const intersect of intersects) {
        ...
        while (obj) {
          if (obj.userData?.isManager) { foundInteractive = 'manager'; break }
          if (obj.userData?.isServiceBell) { foundInteractive = 'bell'; break }
          if (obj.userData?.isTVScreen) { foundInteractive = 'tv'; break }
